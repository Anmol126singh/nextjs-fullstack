...
// Dynamically import react-globe.gl to disable SSR (avoid window error)
const Globe = dynamic(() => import("react-globe.gl"), { ssr: false });

// Note: Unfortunately you cannot type the ref with GlobeMethods properly here
// because dynamic import returns React.ComponentType<any>.
// You can use `any` or `unknown` for globeRef if needed:
...
export default function GlobePage() {
  const globeRef = useRef<any>(null); // Use any for now
  ...
  }, [locations]); // also run effect when locations change
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="p-6">
                <h2 className="text-2xl font-semibold mb-4">See where have you been...</h2>
